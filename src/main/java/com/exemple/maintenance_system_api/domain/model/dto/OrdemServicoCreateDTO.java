...
public record OrdemServicoCreateDTO(String descricao, String status,String tipoManuntencao, Funcionario funcionario, Equipamento equipamento, Usuario usuario) {
}
